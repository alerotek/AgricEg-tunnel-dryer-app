...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent() {
        ...
        this.it = 555;
        this.lo = 1367;
        this.tempDiff = Number((2 * this.dP * (this.tb - this.tc) * (this.it / this.lo)).toFixed(1)); //section 2
        ...
        this.vtc = 650;
        this.lt = Math.round(Number(this.rg * this.vtc * this.tb2) * Math.log(this.pc / Math.pow(10, 5)) * Math.pow(this.vtc - this.tpt, 0.38) / Math.pow(this.vtc - this.tb2, 1.38)); //section 4

        this.v = 0.993831219245376;
        this.mfr = 1.19259746309445;
        this.vam = '';
        this.t = 86400;
        this.p = 1.2; //section 5
        ...
        this.sit = 555;
        this.st = 86400;
        this.ca = Math.round(Number(this.smw * this.slt) / (this.sit * this.st * this.n)); //section 6

        this.nc = 0;
        this.vc = 0;
        this.cv = 0.993831219245376;
        this.w = 0.265;
        this.s = 0.3; //section 7
      ...
      _createClass(AppComponent, [{
        ...
        key: "onWwChange",
        value: function onWwChange($event) {
          this.calculateMm();
        ...
        key: "calculateMm",
        value: function calculateMm() {
          this.mw = Number((this.ww * (this.miwb / 100 - this.mfwb / 100) / (1 - this.mfwb / 100)).toFixed(2));
        }
      }, {
        key: "onMiwbChange",
        value: function onMiwbChange($event) {
          this.calculateMm();
        }
      }, {
        key: "onMfwbChange",
        value: function onMfwbChange($event) {
          this.calculateMm();
        }
      }, {
        key: "calculateMasOfCassavaToDry",
        value: function calculateMasOfCassavaToDry() {
          this.dww = Number(this.ww);
        }
      }, {
        key: "onNChange",
        value: function onNChange($event) {
          this.calculateSolarEnergyCollectionArea();
        }
      }, {
        key: "calculateSolarEnergyCollectionArea",
        value: function calculateSolarEnergyCollectionArea() {
          this.ca = Math.round(this.smw * this.slt / (this.sit * this.st * this.n));
        }
      }, {
        key: "calculateLoadingDensity",
        value: function calculateLoadingDensity() {
          this.ld = this.dww / this.sa;
        }
      }, {
        key: "onVcChange",
        value: function onVcChange($event) {
          if ($event !== '') {
            this.calculateNumberOfChimneys();
          }
        }
      }, {
        key: "calculateNumberOfChimneys",
        value: function calculateNumberOfChimneys() {
          this.nc = Math.round(this.cv / (this.w * this.s * this.vc));
        }
      }, {
        key: "onAtDChange",
        value: function onAtDChange($event) {
        ...
        key: "calculateAmbientTempInKelvin",
        value: function calculateAmbientTempInKelvin() {
          this.atK = Number(this.atD) + 273;
        }
      }, {
        key: "calculateTempOfAirLeavingHeaterInDegrees",
        value: function calculateTempOfAirLeavingHeaterInDegrees() {
          this.taLD = Number(Number(this.atD) + Number(this.tempDiff));
          this.calculateTempOfAirLeavingHeaterInKelvin();
        }
      }, {
        key: "calculateTempOfAirLeavingHeaterInKelvin",
        value: function calculateTempOfAirLeavingHeaterInKelvin() {
          this.to = this.taLD + 273;
        }
      }, {
        key: "calculateTemparatureOfProduct",
        value: function calculateTemparatureOfProduct() {
          this.tp = Number((0.25 * (3 * this.taLD + Number(this.atD))).toFixed(2));
          this.calculateTemparatureOfProductInKelvin();
        }
      }, {
        key: "calculateTemparatureOfProductInKelvin",
        value: function calculateTemparatureOfProductInKelvin() {
          this.tpt = Number(this.tp) + 273;
        }
      }, {
        key: "calculateEnthalpyOfVaporization",
        value: function calculateEnthalpyOfVaporization() {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/felixkiriago/Desktop/Projects/Personal/Angular/malawi/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
